...
1. Metadata is a central concept in QIIME 2.
   ...
   Instead, find discussion of metadata in [our documentation of the metadata file format](xref:using-rachis-target#references:metadata-formatting-reference).
...
Include this barcode information in your [sample metadata](xref:using-rachis-target#references:metadata-formatting-reference) file.
...
Hint: read about [using Artifacts as metadata](xref:using-rachis-target#how-to-guides:view-artifacts-as-metadata) - this is a very powerful concept in QIIME 2, and opens up many diverse analysis possibilities.
:::
