...
If you need to process your data more interactively, you might want to use the Python 3 API, and/or an [Artifact Cache](https://use.qiime2.org/en/2025.7/tutorials/use-the-artifact-cache.html).
...
The metadata file format is defined in *Using QIIME 2* [here](https://use.qiime2.org/en/2025.7/references/metadata.html).
