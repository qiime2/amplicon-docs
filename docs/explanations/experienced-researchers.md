...
If you need to process your data more interactively, you might want to use the Python 3 API, and/or an [Artifact Cache](xref:using-rachis-target#tutorials:artifact-cache-tutorial).
...
The metadata file format is defined in *Using QIIME 2* [here](xref:using-rachis-target#references:metadata-formatting-reference).
