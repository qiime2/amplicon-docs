...
If you'd like to learn more about Artifact Classes, see [*Semantic types, data types, file formats, and artifact classes*](https://develop.qiime2.org/en/2025.10/plugins/explanations/types-of-types.html) in *Developing with QIIME 2*.
...
[^view-options]: Other options for viewing `.qza` and `.qzv` files are discussed [here](https://use.qiime2.org/en/2025.10/how-to-guides/view-visualizations.html).
