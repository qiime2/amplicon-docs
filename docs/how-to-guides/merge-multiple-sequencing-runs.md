...
If that were not the case, you can merge your sample metadata (see [How to merge metadata](https://use.qiime2.org/en/2026.1/how-to-guides/merge-metadata.html)).
