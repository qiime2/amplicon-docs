...
Let\'s subsample the data. We will perform this subsampling in this
...
In this example we have 150-base forward and reverse reads. Since we
...
5.  In taxonomic composition bar plots, sort the samples by their
